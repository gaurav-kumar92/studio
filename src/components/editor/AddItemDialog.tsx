            ...
            <div className="dialog flex flex-col" style={{ maxHeight: '85vh' }}>
                ...
                <div id="add-item-options" className="grid grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto pr-4 flex-grow">
                    ...
                    <button className="add-item-card" data-item-type="arrow" onClick={() => handleItemClick('arrow')}>
                     ...
                     <button className="add-item-card" data-item-type="weather" onClick={() => handleItemClick('weather')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>
                        <span>Weather</span>
                    </button>
                    <button className="add-item-card" data-item-type="astrology" onClick={() => handleItemClick('astrology')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><path d="M12 2.5l1.5 4.5h5l-4 3.5 1.5 4.5-4-3.5-4 3.5 1.5-4.5-4-3.5h5l1.5-4.5z"/></svg>
                        <span>Astrology</span>
                    </button>
                    <button className="add-item-card" data-item-type="music" onClick={() => handleItemClick('music')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>
                        <span>Music</span>
                    </button>
                    <button className="add-item-card" data-item-type="dicesAndTiles" onClick={() => handleItemClick('dicesAndTiles')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="9" cy="9" r="1"></circle><circle cx="15" cy="9" r="1"></circle><circle cx="9" cy="15" r="1"></circle><circle cx="15" cy="15" r="1"></circle></svg>
                        <span>Dices &amp; Tiles</span>
                    </button>
                    <button className="add-item-card" data-item-type="chess" onClick={() => handleItemClick('chess')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><path d="M12 2a10 10 0 1 1-3.53 18.65M12 2a10 10 0 0 0-3.53 18.65M12 2a10 10 0 0 1 3.53 18.65M12 2a10 10 0 0 0 3.53 18.65M12 2L12 22M2 12h20"/></svg>
                        <span>Chess</span>
                    </button>
                    <button className="add-item-card" data-item-type="cards" onClick={() => handleItemClick('cards')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 mx-auto mb-2"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 12h6"/><path d="M12 9v6"/></svg>
                        <span>Cards</span>
                    </button>
                    <button className="add-item-card" data-item-type="recycle" onClick={() => handleItemClick('recycle')}>
