...
type UseDicesAndTilesHandlerProps = {
...
export const useDicesAndTilesHandler = ({
    canvasRef,
    updateLayers,
    setSelectedNodes,
    attachDoubleClick,
    forceRecord,
}: UseDicesAndTilesHandlerProps) => {

    const handleAddDicesAndTiles = useCallback((symbol: string) => {
