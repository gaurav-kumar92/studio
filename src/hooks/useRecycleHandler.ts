...
export const useRecycleHandler = ({
    canvasRef,
    updateLayers,
    setSelectedNodes,
    attachDoubleClick,
    forceRecord,
}: UseRecycleHandlerProps) => {

    const handleAddRecycle = useCallback((symbol: string) => {
