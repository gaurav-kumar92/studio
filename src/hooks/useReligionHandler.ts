...
export const useReligionHandler = ({
    canvasRef,
    updateLayers,
    setSelectedNodes,
    attachDoubleClick,
    forceRecord,
}: UseReligionHandlerProps) => {

    const handleAddReligion = useCallback((symbol: string) => {
